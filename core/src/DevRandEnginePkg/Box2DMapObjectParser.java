...
public class Box2DMapObjectParser {
	...
	public Body createBody(World world, MapObject mapObject) {
		...
		bodyDef.position.set((Float) getProperty(properties, "x", bodyDef.position.x, Integer.class) * unitScale, (Float) getProperty(properties, "y", bodyDef.position.y, Integer.class) * unitScale);
